...
insert into patient (date_of_birth, address_id, id, email, first_name, last_name, pesel_number, patient_number, telephone_number)
            values ('2011-11-29', 1, 1, 'jwasilewski@google.fr', 'Jacek', 'Wasilewski', 11212901535,'201', '703784990'),
                   ('1960-04-12', 2, 2, 'kbrzozowski@1688.com', 'Kornel', 'Brzozowski', 60041202555,'202', '779088870'),
                   ('1947-06-29', 3, 3, 'jsliwinska@google.fr', 'Joanna', 'Śliwińska', 47062903565, '203', '729696313'),
                   ('2024-09-04', 4, 4, 'kkruk@ehow.com', 'Krystian', 'Kruk', 24190404222, '204', '411393837'),
                   ('1970-01-30', 5, 5, 'rdomanski@harvard.edu', 'Radosław', 'Domański', 70013005242, '205', '600519516'),
                   ('1941-05-17', 6, 6, 'agraboeska@hibu.com', 'Agnieszka', 'Grabowska', 41051706666,'206', '775626943'),
                   ('1976-03-07', 7, 7, 'nmarciniak@gizmodo.com', 'Natasza', 'Marciniak', 76030707686,'207', '550145540'),
                   ('1940-10-14', 8, 8, 'zwesolowski@who.int', 'Zenon', 'Wesołowski', 40101408698,'208', '910210215'),
                   ('1984-07-04', 9, 9, 'tczerwinski@geocities.com', 'Tomasz', 'Czerwiński', 84070409936, '209', '768084930'),
                   ('1997-03-14', 10, 10, 'jkot@independent.co.uk', 'Janina', 'Kot', 97031406321,'210','192950959');
